  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-10 justify-center">
        <div className=" bg-white max-h-[400px] w-80 rounded-lg shadow-2xl flex flex-col border pb-3 px-2">
          {/* Set an appointment */}
        ...
        {/* Referred students */}
        <div className="max-h-[400px] w-80 rounded-lg shadow-2xl px-2 flex flex-col border bg-white">
          <div className="flex items-center justify-between border-b">
